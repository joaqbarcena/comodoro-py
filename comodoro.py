...
CERTIFICATE_FIREBASE="google.json"
...
#TODO la idea seria que el modelado de las condiciones
#se puedan escribir aparte del programa, y que este los interprete
...
#change values
if HOST == "somehost.you.have" :
    log("Change the default host")
if PORT == "NNNN": 
    log("Change the default port")

if PORT != "NNNN" and HOST != "somehost.you.have" :
    now = int(time.time())
    try:
        last = open("last","r") #datetime de la ultima vez que genero una alerta
        lass = int(last.read())
    except:
        lass = 0
